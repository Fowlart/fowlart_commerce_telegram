...
public class AdminController {
    ...
    public AdminController(BotVisitorService botVisitorService, @Value("${app.bot.admin.secret}") String adminSecretFromEnv, @Value("${app.bot.email.gmail.user}") String gmailAccName, @Value("${app.bot.host.url}") String hostName, @Value("${app.bot.admins}") String botAdminsList, Catalog catalog, CatalogEnhancer catalogEnhancer, @Value("${azure.storage.container.name}") String containerName, @Value("${azure.storage.connection.string}") String connectionString, @Autowired ActivityTracker activityTracker) {
